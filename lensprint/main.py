...
def create_blurred_frame_with_text(
    image_path,
    output_path,
    exif_text,
    border_radius=60,
    ...
    settings_size = (
        settings_bbox[2] - settings_bbox[0],
    ...
    draw.text(
        (center_x - brand_size[0] // 2, base_y - 40),
        brand_text,
        font=font_bold,
        fill="white",
    )
    draw.text(
        (center_x - model_size[0] // 2, base_y - 10),
        model_text,
        font=font_regular,
        fill="white",
    )
    draw.text(
        (center_x - settings_size[0] // 2, base_y + 20),
        settings_text,
        font=font_regular,
        fill="white",
    )
